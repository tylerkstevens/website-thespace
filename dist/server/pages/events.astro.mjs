...
` })}`, "title": ($$result4) => renderTemplate`${renderComponent($$result4, "Fragment", Fragment, { "slot": "title" }, { "default": ($$result5) => renderTemplate`Events` })}` })} ${maybeRenderHead()}<div class="flex justify-center mt-12" data-astro-cid-ro7pgs3h> <a data-label="Event Calendar Sign Up" style="background-color:#e51f5d;color:#ffffff;min-width:128px;padding:8px 16px;border-radius:8px;text-align:center;font-weight:bold;text-decoration:none;display:inline-block;" href="https://lu.ma/the-space-events" target="_blank" rel="no referrer noopener" data-astro-cid-ro7pgs3h>Subscribe to The Space's Event Calendar</a> </div>  <div class="iframe-container mt-12 mb-20 lg:px-16" data-astro-cid-ro7pgs3h> <iframe src="https://lu.ma/embed/calendar/cal-UDDTjyTDkwIZTOm/events" class="calendar-iframe" allowfullscreen="" aria-hidden="false" tabindex="0" data-astro-cid-ro7pgs3h></iframe> </div> ` })} ` })} `;
